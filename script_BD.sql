...
-- ================================================
-- TABLA: Categories (Categor�as de tareas)
-- ================================================
...
CREATE TABLE Priorities (
    ...
    name NVARCHAR(20) NOT NULL, -- 'Alta', 'Media', 'Baja', 'Cr�tica'
    level_number INT NOT NULL, -- 1=Cr�tica, 2=Alta, 3=Media, 4=Baja
...
CREATE TABLE Task_History (
    ...
    field_name NVARCHAR(50), -- Campo que cambi�
